...
import ManageUser from './pages/admin/manage/userInfo/route/index.js'
    ...
    return (
      ...
      <Router>
        <div>
          ...
          <Route path="/lookNotice" component={LookNotice}></Route>

          {/* 诗人、诗词详情页 */}
          <Route path="/poetInfo/:id" component={PoetInfo}></Route>
          <Route path="/poetryInfo/:id" component={PoetryInfo}></Route>
